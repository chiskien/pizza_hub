...
go
----------------------------------------------Category----------------------------------------
INSERT INTO PizzaHub2.dbo.Categories (CategoryName, Image)
...
-------------------------------------------Drinks--------------------------------------
INSERT INTO PizzaHub2.dbo.Drinks (DrinkName, Brand, Image)
...
---------------------------------------Status---------------------------------------------
INSERT INTO PizzaHub2.dbo.Status (Status)
VALUES (N'Available');
INSERT INTO PizzaHub2.dbo.Status (Status)
...
VALUES (N'On Sale');
--------------------------------------Size------------------------------------------------
INSERT INTO PizzaHub2.dbo.Sizes (Size)
VALUES (N'Personal');
INSERT INTO PizzaHub2.dbo.Sizes (Size)
VALUES (N'Regular');
INSERT INTO PizzaHub2.dbo.Sizes (Size)
VALUES (N'Large');
----------------------------------Base----------------------------------------------------------
INSERT INTO PizzaHub2.dbo.PizzaBases (Base)
VALUES (N'Thin');
INSERT INTO PizzaHub2.dbo.PizzaBases (Base)
VALUES (N'Medium');
INSERT INTO PizzaHub2.dbo.PizzaBases (Base)
VALUES (N'Thick');
----------------------------------------------------Rank----------------------------------
INSERT INTO PizzaHub2.dbo.Ranks (Rank, Description, MinPoint)
...
------------------------------------Sauces-----------------------------------
INSERT INTO PizzaHub2.dbo.Sauces (SauceName)
VALUES (N'Ketchup');
INSERT INTO PizzaHub2.dbo.Sauces (SauceName)
VALUES (N'Hot Sauce');
INSERT INTO PizzaHub2.dbo.Sauces (SauceName)
...
------------------------------Members-------------------------------------
INSERT INTO PizzaHub2.dbo.Members (Email, Password, Avatar, DOB, PhoneNumber, Address, City, Country, Role, Point,
                                   RankId)
...
VALUES (N'guest@gmail.com', N'456', N'peep-1.svg', N'2022-03-26 00:20:19.000', N'123456789', N'SomeStreet', N'SomeCity',
        N'SomeCountry', 0, 0, 1);
----------------------------------------------Pizzas--------------------------------------
INSERT INTO PizzaHub2.dbo.Pizzas (CategoryId, SauceId, Image, Description, StatusId, Price, PizzaName)
...
--------------------------------------------Orders--------------------------------------------
INSERT INTO PizzaHub2.dbo.Orders (MemberId, OrderDate, Address, StatusId, Freight, RequiredDate, ShippedDate, Note)
...
VALUES (2, N'2022-03-26 00:31:29.000', N'HoaLac', 5, 10.0000, N'2022-03-26 00:31:44.000', N'2022-03-26 00:31:50.000',
        N'Guest canceled');
-------------------------------------OrderDetail-----------------------------------------
INSERT INTO PizzaHub2.dbo.OrdersDetail (OrderId, PizzaId, DrinkId, SizeId, BaseId, Quantity, Discount, TotalPrice)
